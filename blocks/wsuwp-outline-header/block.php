...
class Block_WSUWP_Outline_Header extends Block {
	...
	protected static $chars = array(
		...
		'e' => '<svg width="55" height="82" viewBox="0 0 55 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">E</text></svg>',
		'f' => '<svg width="50" height="82" viewBox="0 0 45 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">F</text></svg>',
		'g' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">G</text></svg>',
		'h' => '<svg width="60" height="82" viewBox="0 0 60 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">H</text></svg>',
		...
		'n' => '<svg width="60" height="82" viewBox="0 0 57 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">N</text></svg>',
		...
		'r' => '<svg width="60" height="82" viewBox="0 0 55 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">R</text></svg>',
		's' => '<svg width="50" height="82" viewBox="0 0 45 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">S</text></svg>',
		't' => '<svg width="55" height="82" viewBox="0 0 40 82" style="margin-left:-5px"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">T</text></svg>',
		...
		'w' => '<svg width="90" height="82" viewBox="0 0 74 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">W</text></svg>',
