...
class Block_WSUWP_Outline_Header extends Block {
	...
	protected static $chars = array(
		'a' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">A</text></svg>',
		'b' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">B</text></svg>',
		'c' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">C</text></svg>',
		'd' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">D</text></svg>',
		'e' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">E</text></svg>',
		...
		'i' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">I</text></svg>',
		...
		'o' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">O</text></svg>',
		'p' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">P</text></svg>',
		...
		't' => '<svg width="70" height="82" viewBox="0 0 62 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">T</text></svg>',
		'u' => '<svg width="60" height="82" viewBox="0 0 60 82"><text x="0" y="63" class="wsu-header__ouline-text" alignment-baseline="top">U</text></svg>',
